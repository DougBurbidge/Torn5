...
namespace Torn5.Controls
{
	public partial class PyramidHalfFixture : UserControl
	{
		...
		public int TeamsIn { get => (int)numericTeams.Value; set => numericTeams.Value = value; }
		public int TeamsOut { get => (int)numericTeams.Value - (int)numericAdvance.Value; }
		public int Games { get => (int)numericGames.Value; set { if (value > 0) numericGames.Value = value; } }
		public int Advance { get => (int)numericAdvance.Value; set => numericAdvance.Value = value; }
